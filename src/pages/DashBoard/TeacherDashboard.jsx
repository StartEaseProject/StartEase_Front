    ...
    <>
      ...
      {!loading && (
        <section className='px-layout'>
          <h1 className='text-thirdColor text-fs-500 pb-6'>Statistics:</h1>
          <div className='flex justify-center items-center gap-16'>
            <CountCard name='Supervisors' number={data?.by_role.supervisor} />
            <CountCard
              name='Project Holders'
              number={data?.by_role.project_holder}
            />
            <CountCard
              name='Co-Supervisors'
              number={data?.by_role.co_supervisor}
            />
          </div>
